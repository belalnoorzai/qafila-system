...
client.on('ebnklb',function(ebnklb) {
    ...
    if(ebnklb.content.startsWith(`<@${client.user.id}>`)) {
        ebnklb.channel.send('Hey Im **Haron bot !**  A Nice Bot Developed By:`MHSTR`')
...
client.on('message', message => {
if (message.content.startsWith(prefix + 'مساعدة')) { /// This is The DMS Code Send The Help In DMS // Code By NotGucci
    let pages = [`
***__وصف عن البوت__***
**
